...
var colors = ["Blue", "Green", "Red", "Yellow", "White", "Gray", "Orange", "Cyan", "Purple", "Pink", "Lime", "Magenta", "Aquamarine", "Maroon", "Azure", "Aqua", "Fuchsia", "Violet", "Powder blue"]; // Event Listeners
...
var Player = /*#__PURE__*/function () {
  function Player(x, y, radius, color, keysPressData) {
  ...
  _createClass(Player, [{
    ...
    value: function draw() {
      ...
      var mouseDgree = Math.atan2(mouse.y - this.y, mouse.x - this.x);
      c.rotate(mouseDgree);
      c.beginPath();
      c.moveTo(-(this.radius - this.radius / 3), -(this.radius - this.radius / 3));
...
var Proectile = /*#__PURE__*/function () {
  function Proectile(x, y, radius, color, velocity) {
    _classCallCheck(this, Proectile);
...
var Enemy = /*#__PURE__*/function () {
  function Enemy(x, y, radius, color, circleOrRect) {
    ...
    this.radius = radius;
    this.color = color;
    this.velocity = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.randomIntFromRange)(3, 5);
    this.randomEnemy = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.randomIntFromRange)(1, 10);
  ...
  _createClass(Enemy, [{
    ...
    value: function update(player) {
      var playerAngle = Math.atan2(player.y - this.y, player.x - this.x);

      if (this.randomEnemy < 3) {
        var randomVelocity = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.randomIntFromRange)(5, 10);
...
var Enemy3 = /*#__PURE__*/function () {
  function Enemy3(x, y, radius, color, circleOrRect) {
    ...
    this.color = color;
    this.velocity = {
      x: (0,_utils__WEBPACK_IMPORTED_MODULE_0__.randomIntFromRange)(1, 7),
      y: (0,_utils__WEBPACK_IMPORTED_MODULE_0__.randomIntFromRange)(1, 7)
    };
  }
...
var BurstParticles = /*#__PURE__*/function () {
  function BurstParticles(x, y, radius, color, velocity) {
    _classCallCheck(this, BurstParticles);
...
var particles = [];
var score = 0;
var clickCounter = 0; // creating player
...
player = new Player(200, canvas.height / 2, 15, "white", keysPressData); // particles spread effect after after enemy is attacked

var createParticles = function createParticles(injuredEnemy, particlesLength) {
  for (var i = 0; i < particlesLength * 2; i++) {
    var radius = Math.random() * 2;
    var randomSpeedPlus = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.randomIntFromRange)(1, 3);
    var speedX = Math.cos(i) * randomSpeedPlus;
    var speedY = Math.sin(i) * randomSpeedPlus;
    particles.push(new BurstParticles(injuredEnemy.x + (0,_utils__WEBPACK_IMPORTED_MODULE_0__.randomIntFromRange)(-injuredEnemy.radius, 0), injuredEnemy.y + (0,_utils__WEBPACK_IMPORTED_MODULE_0__.randomIntFromRange)(-injuredEnemy.radius, 0), radius, injuredEnemy.color, {
      x: speedX,
      y: speedY
    }));
  }
...
var createEnemy = function createEnemy() {
  var spawnPosX = Math.random();
  var spawnPosY = Math.random();
  var rdmNum = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.randomIntFromRange)(1, 10);
  var enmey1Or2 = Math.floor((0,_utils__WEBPACK_IMPORTED_MODULE_0__.randomIntFromRange)(0, 3));
  var radius = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.randomIntFromRange)(8, 50);
  var circleOrRect = rdmNum > 5 ? "circle" : "rectangle";
  ...
  if (!enmey1Or2) {
    enemies.push(new Enemy3(canvas.width / 2, canvas.height / 2, radius, (0,_utils__WEBPACK_IMPORTED_MODULE_0__.randomColor)(colors), circleOrRect));
  } // if (!enmey1Or2) {
...
intervelTime = setInterval(createEnemy, 1500); // here creating projectiles on click

var creatProjecTile = function creatProjecTile() {
  clickCounter++;

  if (clickCounter > 1) {
    var mouseDgree = Math.atan2(mouse.y - player.y, mouse.x - player.x);
    projectiles.push(new Proectile(player.x, player.y, 3, "white", {
...
function animate() {
  ...
  projectiles.forEach(function (projectile, index) {
    if (projectile.x > canvas.width || projectile.x < 0 || projectile.y > canvas.height || projectile.y > canvas.height) {
